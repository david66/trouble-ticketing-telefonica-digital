...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("footerTemplate.html",
    ...
    "        </div>" +
    "        <div style=\"background-color: #EAEAEA; border: 1px solid #D1D7DF; display:inline; margin-right: 15px; padding:3px 8px 1px; border-radius: 4px;\">{{pagingOptions.currentPage}}/{{maxPages()}}</div>" +
    "    </div>" +
    "</div>"
  );
